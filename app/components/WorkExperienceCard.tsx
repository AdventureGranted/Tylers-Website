...
export default function WorkExperienceCard() {
  return (
    <div className="max-w-full bg-gray-800 rounded-4xl shadow-md mt-8">
      ...
      <div className="w-3/4 md:w-1/2 xl:w-1/4 h-1 bg-gray-400 rounded mx-auto mt-2 mb-2" />
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between items-center w-full">
              <div className="flex flex-col lg:flex-row items-center">
                ...
                <h2 className="text-left lg:ml-4 lg:mt-1 text-md">
                  {exp.role}
                </h2>
              </div>
              <h2 className="text-right text-md lg:mt-1 whitespace-nowrap">
                {exp.date}
              </h2>
            </div>
