    ...
    <div className="min-h-screen bg-gray-100 px-4 py-12 dark:bg-gray-900">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 text-center">
          ...
          <div className="mx-auto h-6 w-96 animate-pulse rounded-lg bg-white dark:bg-gray-800" />
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            ...
            >
              ...
              <div className="p-4">
                <div className="mb-2 h-6 w-3/4 animate-pulse rounded bg-white dark:bg-gray-700" />
                <div className="h-4 w-full animate-pulse rounded bg-white dark:bg-gray-700" />
                <div className="mt-1 h-4 w-2/3 animate-pulse rounded bg-white dark:bg-gray-700" />
              </div>
            </div>
          ))}
        </div>
