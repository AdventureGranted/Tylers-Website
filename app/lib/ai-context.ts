...
- **Tinkering with Tech:** Always exploring new technologies and self-hosting solutions
- **Cabinetry & Woodworking:** Builds custom projects in his workshop
...
- Tyler tried to be the TA that didn't just give answers or dismiss code because it wasn't written like the solution. He truly understood each student's approach so he could quickly assess and guide them to success.

**Retention TA:**
- Hand-picked by the professor to help struggling students succeed in foundational CS courses through extra sessions and guidance

**UGSAC Secretary:**
- Undergraduate Student Advisory Committee member
- Worked with professors, participated in faculty hiring interviews, and organized CS events
